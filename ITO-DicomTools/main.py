...
def main(page: ft.Page):
    ...
    page.window_width = 800  # Largeur fixe de la fenêtre
    page.window_height = 800  # Hauteur fixe de la fenêtre
    page.window_resizable = True  # Désactivation du redimensionnement de la fenêtre
